                            ...
                            <div className = "container-fluid">
                                ...
                                <div className="row rowStyle">
                                    <div className="col-lg-6 col-md-6 col-sm-6 formBody">
                                        ...
                                        <input id="donor-email" type="email" name="donorEmail" onBlur={(e) => this.confirmEmail()} defaultValue="kiplangat@gmail.com" className="form-control inputStyle" placeholder="Your Email" required />
                                ...
                                <div className="row rowStyle">
                                    <div className="col-lg-12 col-md-6 col-sm-6 formBody">
                                        ...
                                        <input id="donor-phoneNumber" type="tel" name="donorMobile" defaultValue="0740756210" className="form-control inputStyle" required maxLength="11" />
                                    </div>
                                ...
                                <div className="row rowStyle">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-6 formBody">
                                        ...
                                        <input id="donor-city" type="text" name="donorCity" className="form-control inputStyle" placeholder="Kisii" required />
                                    </div>
                                </div>
                                <div className="row rowStyle">
                                    <div className="col-lg-6 col-md-6 col-sm-6 formBody">
                                        <label htmlFor="inputGoogleProvince" className="labelValues">County:</label>
                                        <input id="donor-Province" type="text" name="donorProvince" className="form-control inputStyle" placeholder="kisii" required />
                                    </div>
                                    <div className="col-lg-6 col-md-6 col-sm-6 formBody">
                                        <label htmlFor="inputcountry" className="labelValues">Country:</label>
                                        <input id="donor-country" type="text" name="donorCountry" className="form-control inputStyle" placeholder="Kenya" required />
                                    </div>
                                </div>
                                <div >
